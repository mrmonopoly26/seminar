...
\begin{enumerate}
    \item What are the architectural differences between \acp{SNN} and \acp{ANN}?
...
After that, a comparison of \acp{SNN} and \acp{ANN} will be conducted with a focus on performance aspects when executed on \acp{GPU}.
